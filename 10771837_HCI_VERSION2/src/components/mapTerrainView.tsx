// src/components/mapTerrainView.tsx
...
interface MapTerrainViewProps {
  earthquakes: Earthquake[];
  onMarkerPress: (earthquakeId: string) => void;
}

const MapTerrainView: React.FC<MapTerrainViewProps> = ({ 
  earthquakes, 
  onMarkerPress 
}) => {
  ...
  // Custom map style for terrain view - light blue with minimal details
